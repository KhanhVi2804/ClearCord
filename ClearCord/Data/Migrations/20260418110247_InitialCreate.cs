        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServerBans_AspNetUsers_BannedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServerRoleAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServerRoleAssignments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServerRoleAssignments_ServerRoles_ServerRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoiceChannelParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VoiceChannelParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VoiceChannelParticipants_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerBans_BannedByUserId",
                table: "ServerBans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerRoleAssignments_ServerRoleId_UserId",
                table: "ServerRoleAssignments",
                columns: new[] { "ServerRoleId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServerRoleAssignments_UserId",
                table: "ServerRoleAssignments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoiceChannelParticipants_ChannelId_UserId_ConnectionId",
                table: "VoiceChannelParticipants",
                columns: new[] { "ChannelId", "UserId", "ConnectionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VoiceChannelParticipants_UserId",
                table: "VoiceChannelParticipants",
                column: "UserId");
        }
