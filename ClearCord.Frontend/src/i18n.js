...
const messages = {
  en: {
    ...
    assistant: {
      ...
      title: "Clear",
      open: "Open Clear assistant",
      heard: "Heard",
      ask: "Ask",
      you: "You",
      startListening: "Talk to Clear",
      stopListening: "Stop listening",
      statusIdle: "Clear is listening for 'Hey Clear'. You can also press Ctrl+Space or the microphone to speak right away.",
      statusIdleShortcutOnly: "Hey Clear is off. Press Ctrl+Space or use the microphone to speak to Clear.",
      statusWakeListening: "Listening for 'Hey Clear'...",
      statusWakeDetected: "Clear heard the wake phrase and is answering you...",
      statusShortcutPreparing: "Clear is opening from the keyboard shortcut...",
      statusCommandListening: "Clear is listening for your command now.",
      statusRecipientPreparing: "Clear is asking who should receive the message...",
      statusRecipientListening: "Clear is listening for the recipient now.",
      statusDraftPreparing: "Clear is ready to capture your message content...",
      statusDraftListening: "Clear is recording the message for {name}. Pause for about 3 seconds and Clear will send it automatically.",
      statusThinking: "Thinking and preparing an action...",
      statusSpeaking: "Speaking back to you...",
      wakeAcknowledgement: "I'm listening, boss.",
      shortcutAcknowledgement: "I'm listening, boss.",
      askRecipient: "Who should I send it to?",
      recipientNotFound: "I could not find {name} in your friend list yet. Who would you like me to send it to?",
      wakePhraseRequired: "Start by saying 'Hey Clear', then wait for Clear to reply before giving the command.",
      draftSessionHint: "Drafting a message for {name}. Dictate the content and Clear will send it after about 3 seconds of silence.",
      draftNoContent: "I have not captured any message content yet. Please speak the message content.",
      manualPlaceholder: "Type a fallback command for Clear",
      emptyState: "Voice requests and replies will appear here.",
      recognitionUnsupported: "This browser does not support speech recognition. You can still type into the assistant box.",
      speechUnsupported: "This browser cannot read replies aloud, but Clear can still act on your requests.",
      micDenied: "Microphone permission was denied.",
      noSpeech: "I could not hear any speech. Try again a bit closer to the microphone.",
      audioCaptureFailed: "Microphone audio could not be captured.",
      networkFailed: "Speech recognition could not reach the browser speech service. Check your network and try again.",
      languageNotSupported: "This browser does not support speech recognition for the current language.",
      listeningStopped: "Voice listening was stopped before a command was captured.",
      secureContextRequired: "Voice recognition needs a secure browser context such as localhost or HTTPS.",
      recognitionFailed: "Speech recognition failed. Please try again.",
      contextGlobal: "Assistant context: your current workspace session",
      contextServer: "Assistant context: server {server}",
      contextChannel: "Assistant context: #{channel} in {server}",
      contextDirect: "Assistant context: direct conversation with {name}"
    },
    settings: {
      eyebrow: "Quick settings",
      title: "Assistant and sounds",
      clearToggle: "Enable Clear",
      clearToggleHint: "Turn background Hey Clear listening on or off.",
      openAssistant: "Open Clear",
      notificationVolume: "Notification volume",
      notificationVolumeHint: "Current volume: {percent}%"
    }
  },
  vi: {
    app: {
    ...
    assistant: {
      eyebrow: "Trợ lý giọng nói",
      title: "Clear",
      open: "Mở trợ lý Clear",
      heard: "Clear nghe được",
      ask: "Gửi",
      you: "Bạn",
      startListening: "Nói với Clear",
      stopListening: "Dừng nghe",
      statusIdle: "Clear đang chờ nghe 'Hey Clear'. Bạn cũng có thể nhấn Ctrl+Space hoặc bấm micro để nói ngay.",
      statusIdleShortcutOnly: "Hey Clear đang tắt. Bạn vẫn có thể nhấn Ctrl+Space hoặc bấm micro để nói với Clear.",
      statusWakeListening: "Đang nghe từ khóa 'Hey Clear'...",
      statusWakeDetected: "Clear đã nghe thấy từ khóa và đang trả lời bạn...",
      statusShortcutPreparing: "Clear đang mở từ phím tắt...",
      statusCommandListening: "Clear đang nghe lệnh của bạn.",
      statusRecipientPreparing: "Clear đang hỏi bạn muốn gửi cho ai...",
      statusRecipientListening: "Clear đang nghe tên người nhận.",
      statusDraftPreparing: "Clear đã sẵn sàng tiếp nhận nội dung tin nhắn...",
      statusDraftListening: "Clear đang ghi nội dung tin nhắn cho {name}. Bạn ngừng nói khoảng 3 giây là mình sẽ tự gửi.",
      statusThinking: "Đang hiểu yêu cầu và chuẩn bị hành động...",
      statusSpeaking: "Đang phản hồi bằng giọng nói...",
      wakeAcknowledgement: "Đang nghe đây sếp.",
      shortcutAcknowledgement: "Đang nghe đây sếp.",
      askRecipient: "Bạn muốn mình gửi cho ai?",
      recipientNotFound: "Mình chưa tìm thấy {name} trong danh sách bạn bè. Bạn muốn mình gửi cho ai?",
      wakePhraseRequired: "Hãy bắt đầu bằng 'Hey Clear', đợi Clear trả lời rồi mới nói lệnh.",
      draftSessionHint: "Đang soạn tin nhắn cho {name}. Bạn chỉ cần đọc nội dung, rồi ngừng nói khoảng 3 giây để mình tự gửi.",
      draftNoContent: "Mình chưa ghi nhận được nội dung tin nhắn nào. Bạn hãy đọc nội dung tin nhắn giúp mình.",
      manualPlaceholder: "Nhập lệnh dự phòng cho Clear",
      emptyState: "Lịch sử trao đổi với trợ lý giọng nói sẽ hiện ở đây.",
      recognitionUnsupported: "Trình duyệt này không hỗ trợ nhận diện giọng nói. Bạn vẫn có thể nhập lệnh trong hộp trợ lý.",
      speechUnsupported: "Trình duyệt này không thể đọc phản hồi thành tiếng, nhưng Clear vẫn có thể thực hiện yêu cầu.",
      micDenied: "Bạn đã từ chối quyền micro.",
      noSpeech: "Mình chưa nghe rõ giọng nói. Hãy thử lại gần micro hơn.",
      audioCaptureFailed: "Không thể lấy âm thanh từ micro.",
      networkFailed: "Nhận diện giọng nói không kết nối được tới dịch vụ speech của trình duyệt. Hãy kiểm tra mạng rồi thử lại.",
      languageNotSupported: "Trình duyệt này chưa hỗ trợ nhận diện giọng nói cho ngôn ngữ hiện tại.",
      listeningStopped: "Phiên nghe giọng nói đã dừng trước khi ghi nhận được lệnh.",
      secureContextRequired: "Nhận diện giọng nói cần môi trường an toàn như localhost hoặc HTTPS.",
      recognitionFailed: "Nhận diện giọng nói thất bại. Hãy thử lại.",
      contextGlobal: "Ngữ cảnh trợ lý: phiên làm việc hiện tại của bạn",
      contextServer: "Ngữ cảnh trợ lý: server {server}",
      contextChannel: "Ngữ cảnh trợ lý: kênh #{channel} trong {server}",
      contextDirect: "Ngữ cảnh trợ lý: trò chuyện riêng với {name}"
    },
    settings: {
      eyebrow: "Cài đặt nhanh",
      title: "Clear và âm báo",
      clearToggle: "Bật Clear",
      clearToggleHint: "Bật hoặc tắt chế độ nghe nền Hey Clear.",
      openAssistant: "Mở Clear",
      notificationVolume: "Âm lượng thông báo",
      notificationVolumeHint: "Âm lượng hiện tại: {percent}%"
    }
  }
};
